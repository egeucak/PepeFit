...
public class AdminPanelBean {
	...
	public String redirectAddMember() {
		return "addMember.xhtml?faces-redirect=true";
	}
	public String redirectDeleteMember() {
		return "deleteMember.xhtml?faces-redirect=true";
	}
	public String redirectUpdateMember() {
		return "updateMember.xhtml?faces-redirect=true";
	}
	public String redirectAddTrainer() {
		return "addTrainer.xhtml?faces-redirect=true";
	}
	public String redirectDeleteTrainer() {
		return "deleteTrainer.xhtml?faces-redirect=true";
	}
	public String redirectUpdateTrainer() {
		return "updateTrainer.xhtml?faces-redirect=true";
	}
